...
ChordialSynthDemoAudioProcessorEditor::ChordialSynthDemoAudioProcessorEditor (ChordialSynthDemoAudioProcessor& p)
    : AudioProcessorEditor (&p), processor (p), keyboard(p.getKeyboardState(), MidiKeyboardComponent::Orientation::horizontalKeyboard)
{
...
void ChordialSynthDemoAudioProcessorEditor::resized()
{
	...
	keyboard.setKeyWidth(bounds.getWidth() / 28.0f);
